$(document).ready(function(){
    ...
    let input = document.querySelector("#input_phone_buy");
    window.intlTelInput(input, {   
       excludeCountries: ["ba" , "cf" , "cd" , "cg" , "gq" , "do" , "pf" , "nc" , "kp","pm","mf","st","wf"],
       hiddenInput: "full_number",
       nationalMode: false,
      preferredCountries: ['ua'],
      utilsScript: "/success/scripts/lib/mask/utils.js",
    });

    let input2 = document.querySelector("#input_phone_callback");
    ...
    let countdown = new Date(2022, 08, 02);
    ...
    //$("#input_phone_buy").inputmask({"mask": "+38 (999) 999-99-99"});
    //init limit program
    let limit = 4;
